...
<div class="content">
	...
	<section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-1">
		<div class="h-24 mt-10">		
			<h1 class="h-auto">Our Team</h1>	
		</div>	
		<div class="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-2 lg:my-0">
    
			<!--Main Col-->
			<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0 mb-10">
				...
				<div class="p-4 md:p-12 text-center lg:text-left">
					...
					<h1 class="text-3xl font-bold pt-8 lg:pt-0">Oluwatomijogun Ogedengbe </h1>
					<div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
					<!-- <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start"><svg class="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M9 12H1v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6h-8v2H9v-2zm0-1H0V5c0-1.1.9-2 2-2h4V2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v1h4a2 2 0 0 1 2 2v6h-9V9H9v2zm3-8V2H8v1h4z"/></svg> Chief Operations Officer </p>
					<a href="https://www.google.com/maps/place/Olaide+Tomori+St,+Ikeja+101233,+Ikeja/@6.5938715,3.3356925,17z/data=!3m1!4b1!4m5!3m4!1s0x103b918a1fbd2aab:0xa1df61e4781c6fbf!8m2!3d6.5938715!4d3.3378865"><p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start"><svg class="h-4 fill-current text-green-700 pr-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10 20a10 10 0 1 1 0-20 10 10 0 0 1 0 20zm7.75-8a8.01 8.01 0 0 0 0-4h-3.82a28.81 28.81 0 0 1 0 4h3.82zm-.82 2h-3.22a14.44 14.44 0 0 1-.95 3.51A8.03 8.03 0 0 0 16.93 14zm-8.85-2h3.84a24.61 24.61 0 0 0 0-4H8.08a24.61 24.61 0 0 0 0 4zm.25 2c.41 2.4 1.13 4 1.67 4s1.26-1.6 1.67-4H8.33zm-6.08-2h3.82a28.81 28.81 0 0 1 0-4H2.25a8.01 8.01 0 0 0 0 4zm.82 2a8.03 8.03 0 0 0 4.17 3.51c-.42-.96-.74-2.16-.95-3.51H3.07zm13.86-8a8.03 8.03 0 0 0-4.17-3.51c.42.96.74 2.16.95 3.51h3.22zm-8.6 0h3.34c-.41-2.4-1.13-4-1.67-4S8.74 3.6 8.33 6zM3.07 6h3.22c.2-1.35.53-2.55.95-3.51A8.03 8.03 0 0 0 3.07 6z"/></svg> Lagos, Nigeria</p></a> -->
					<p class="pt-8 text-sm">Oluwatomijogun Ogedengbe is a geoscientist with over 20 years experience in subsurface functions including exploration, asset development and a specialty in technical geophysics. He has a Bachelors degree in Geology from the University of Ibadan and a Masters in Applied Geophysics from the University of Lagos. Oluwatomijogun has held several roles as an explorationist including leading a geoscience team in Houston, Texas. His broad technical experience cuts across several African countries including Nigeria, Ghana, Cameroon, Equatorial Guinea, Cote d'voire, Senegal and Mauritania</p>					
					<p class="pt-8 text-sm">Oluwatomijogun currently provides technical and business insights during the planning and execution of exploration work programs. He also leverages connection with partners, government, academia, associations and is involved in broad industry advocacy.</p>
		
					<div class="pt-12 pb-8">
						<a href="mailto:joguno@petraton.com"><button class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
						  Get In Touch
						</button></a> 
					</div>
			...
			<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0 mb-10">
				...
				<div class="p-4 md:p-12 text-center lg:text-left ">
					...
					<div class="pt-12 pb-8">
						<a href="mailto:ladid@petraton.com"><button class="bg-green-700 hover:bg-green-900 text-white font-bold py-2 px-4 rounded-full">
						  Get In Touch
						</button></a> 
					</div>
