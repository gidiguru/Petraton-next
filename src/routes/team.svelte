		...
		<div class="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-2 lg:my-0">
			...
			<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0 mb-10">
				...
				<div class="p-4 md:p-12 text-center lg:text-left">
					...
					<p class="pt-8 text-sm">Oluwatomijogun Ogedengbe is a geoscientist with over 20 years experience in subsurface functions including exploration, asset development and a specialty in techinical geophysics. He has a Bachelors degree in Geology from the University of Ibadan and a Masters in Applied Geophysics from the University of Lagos. Oluwatomijogun has held several roles as an explorationist including leading a geoscience team in Houston. TX. His broad technical experience cuts across several African countries including Nigeria, Ghana, Cameroon, Equatorial Guinea, Cote d'voire, Senegal and Mauritania</p>					
