		...
		<div class="max-w-4xl flex items-center h-auto flex-wrap mx-auto my-2 lg:my-0">
			...
			<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 mx-6 lg:mx-0">
				...
				<div class="p-4 md:p-12 text-center lg:text-left">
					...
					<p class="pt-8 text-sm">As the Chief Operations Officer, Ladi Delano is using his exceptional insight into company management to enhance the operations of Petraton. With his leadership, Petraton has established strong relations with the communities we operate in and with all governing and regulatory bodies to establish the company as preferred operator in the exploration and mining industry.</p>
